...
public:
	...
	FVector2D() {}
	FVector2D(float InX, float InY) noexcept :
		X(InX), Y(InY)
	{

	}
	FVector2D(const FVector2D& V2) noexcept :
		X(V2.X), Y(V2.Y)
	{
...
public:
	...
	*/
	FORCEINLINE FVector2D operator+(const FVector2D& V) const noexcept
	{
	...
	*/
	FORCEINLINE FVector2D operator-() const noexcept
	{
	...
	*/
	...
	/*
		...
		@return Copy of the vector after division.
	*/
	FORCEINLINE FVector2D operator/=(float V) noexcept
	{
	...
	*/
	FORCEINLINE FVector2D operator+(float A) const noexcept
	{
	...
	*/
	FORCEINLINE float operator|(const FVector2D& V) const noexcept
	{
		return X * V.X + Y * V.Y;
	}
...
public:
	...
	/*
		...
		@return The dot product.
	*/
	static FORCEINLINE float DotProduct(const FVector2D& A, const FVector2D& B) noexcept
	{
		return A | B;
	}
	...
	*/
	static FORCEINLINE float DistSquared(const FVector2D& V1, const FVector2D& V2) noexcept
	{
	...
	*/
	static FORCEINLINE float Distance(const FVector2D& V1, const FVector2D& V2) noexcept
	{
	...
	/*
		...
		@return The cross product.
	*/
	static FORCEINLINE float CrossProduct(const FVector2D& A, const FVector2D& B) noexcept
	{
		return A ^ B;
	}
	...
	*/
	static FORCEINLINE FVector2D Max(const FVector2D& A, const FVector2D& B) noexcept
	{
	...
	*/
	static FORCEINLINE FVector2D Min(const FVector2D& A, const FVector2D& B) noexcept
	{
...
public:
	...
	*/
	FORCEINLINE bool Equals(const FVector2D& V, float Tolerance = KINDA_SMALL_NUMBER) const noexcept
	{
	...
	*/
	FORCEINLINE FVector2D RoundToVector() const noexcept
	{
	...
	*/
	FORCEINLINE FVector2D ClampAxes(float MinAxisVal, float MaxAxisVal) const noexcept
	{
	...
	*/
	FORCEINLINE FVector2D GetAbs() const noexcept
	{
