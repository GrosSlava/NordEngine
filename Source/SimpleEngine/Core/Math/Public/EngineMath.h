...
struct ENGINE_API FMath
{
	...
	*/
	static FORCEINLINE bool IsNearlyEqual(float A, float B, float ErrorTolerance = SMALL_NUMBER) noexcept
	{
	...
	*/
	static FORCEINLINE bool IsNearlyZero(double Value, double ErrorTolerance = SMALL_NUMBER) noexcept
	{
	...
	*/
	static FORCEINLINE float Floor(float F) noexcept
	{
	...
	*/
	static constexpr int TruncToInt(float F) noexcept
	{
		return (int)F;
	}
	...
	*/
	static FORCEINLINE float TruncToFloat(float F) noexcept
	{
		return truncf(F);
	}
	...
	/*
		...
		@return		Truncated integer value.
	*/
	static FORCEINLINE double TruncToDouble(double F) noexcept
	{
		return trunc(F);
	}
	...
	*/
	static FORCEINLINE int FloorToInt(float F) noexcept
	{
	...
	/*
		...
		@return		An integer less or equal to 'F'.
	*/
	static FORCEINLINE float FloorToFloat(float F) noexcept
	{
		return floorf(F);
	}
	...
	*/
	static FORCEINLINE double FloorToDouble(double F) noexcept
	{
		return floor(F);
	}
	...
	*/
	static FORCEINLINE int RoundToInt(float F) noexcept
	{
	...
	/*
		...
		@return		The nearest integer to 'F'.
	*/
	static FORCEINLINE float RoundToFloat(float F) noexcept
	{
	...
	/*
		...
		@return		The nearest integer to 'F'.
	*/
	static FORCEINLINE double RoundToDouble(double F) noexcept
	{
	...
	*/
	static FORCEINLINE int CeilToInt(float F) noexcept
	{
	...
	/*
		...
		@return		An integer greater or equal to 'F'.
	*/
	static FORCEINLINE float CeilToFloat(float F) noexcept
	{
		return ceilf(F);
	}
	...
	/*
		...
		@return		An integer greater or equal to 'F'.
	*/
	static FORCEINLINE double CeilToDouble(double F) noexcept
	{
		return ceil(F);
	}
	...
	*/
	static FORCEINLINE float Fractional(float Value) noexcept
	{
	...
	*/
	static FORCEINLINE float Frac(float Value) noexcept
	{
	...
	*/
	static FORCEINLINE float Modf(const float InValue, float* OutIntPart) noexcept
	{
	...
	/*
		...
		@return				The fractional part of the number.
	*/
	static FORCEINLINE double Modf(const double InValue, double* OutIntPart) noexcept
	{
	...
	*/
	template< class T >
	static FORCEINLINE T InterpStep(const T& A, const T& B, float Alpha, int Steps)
	{
		if (Steps <= 1 || Alpha <= 0)
		{
			return A;
