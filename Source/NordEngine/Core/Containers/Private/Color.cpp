...
const FColor FColor::Aquamarine(112, 219, 147, 255);
const FColor FColor::BakerChocolate(92, 51, 23, 255);
const FColor FColor::BlueViolet(159, 95, 159, 255);
const FColor FColor::Brass(181, 166, 66, 255);
const FColor FColor::BrightGold(217, 217, 25, 255);
const FColor FColor::Brown(166, 42, 42, 255);
const FColor FColor::Bronze(140, 120, 83, 255);
const FColor FColor::BronzeII(166, 125, 61, 255);
const FColor FColor::CadetBlue(95, 159, 159, 255);
const FColor FColor::CoolCopper(217, 135, 25, 255);
const FColor FColor::Copper(184, 115, 51, 255);
const FColor FColor::Coral(255, 127, 0, 255);
const FColor FColor::CornFlowerBlue(66, 66, 111, 255);
const FColor FColor::DarkBrown(92, 64, 51, 255);
const FColor FColor::DarkGreen(47, 79, 47, 255);
const FColor FColor::DarkGreenCopper(74, 118, 110, 255);
const FColor FColor::DarkOliveGreen(79, 79, 47, 255);
const FColor FColor::DarkOrchid(153, 50, 205, 255);
const FColor FColor::DarkPurple(135, 31, 120, 255);
const FColor FColor::DarkSlateBlue(107, 35, 142, 255);
const FColor FColor::DarkSlateGrey(47, 79, 79, 255);
const FColor FColor::DarkTan(151, 105, 79, 255);
const FColor FColor::DarkTurquoise(112, 147, 219, 255);
const FColor FColor::DarkWood(133, 94, 66, 255);
const FColor FColor::DimGrey(84, 84, 84, 255);
const FColor FColor::DustyRose(133, 99, 99, 255);
const FColor FColor::Feldspar(209, 146, 117, 255);
const FColor FColor::Firebrick(142, 35, 35, 255);
const FColor FColor::ForestGreen(35, 142, 35, 255);
const FColor FColor::Gold(205, 127, 50, 255);
const FColor FColor::Goldenrod(219, 219, 112, 255);
const FColor FColor::Grey(192, 192, 192, 255);
const FColor FColor::GreenCopper(82, 127, 118, 255);
const FColor FColor::GreenYellow(147, 219, 112, 255);
const FColor FColor::HunterGreen(33, 94, 33, 255);
const FColor FColor::IndianRed(78, 47, 47, 255);
const FColor FColor::Khaki(159, 159, 95, 255);
const FColor FColor::LightBlue(192, 217, 217, 255);
const FColor FColor::LightGrey(168, 168, 168, 255);
const FColor FColor::LightSteelBlue(143, 143, 189, 255);
const FColor FColor::LightWood(233, 194, 166, 255);
const FColor FColor::LimeGreen(50, 205, 50, 255);
const FColor FColor::MandarianOrange(228, 120, 51, 255);
const FColor FColor::Maroon(142, 35, 107, 255);
const FColor FColor::MediumAquamarine(50, 205, 153, 255);
const FColor FColor::MediumBlue(50, 50, 205, 255);
const FColor FColor::MediumForestGreen(107, 142, 35, 255);
const FColor FColor::MediumGoldenrod(234, 234, 174, 255);
const FColor FColor::MediumOrchid(147, 112, 219, 255);
const FColor FColor::MediumSeaGreen(66, 111, 66, 255);
const FColor FColor::MediumSlateBlue(127, 0, 255, 255);
const FColor FColor::MediumSpringGreen(127, 255, 0, 255);
const FColor FColor::MediumTurquoise(112, 219, 219, 255);
const FColor FColor::MediumVioletRed(219, 112, 147, 255);
const FColor FColor::MediumWood(166, 128, 100, 255);
const FColor FColor::MidnightBlue(47, 47, 79, 255);
const FColor FColor::NavyBlue(35, 35, 142, 255);
const FColor FColor::NeonBlue(77, 77, 255, 255);
const FColor FColor::NeonPink(255, 110, 199, 255);
const FColor FColor::NewMidnightBlue(0, 0, 156, 255);
const FColor FColor::NewTan(235, 199, 158, 255);
const FColor FColor::OldGold(207, 181, 59, 255);
const FColor FColor::Orange(255, 127, 0, 255);
const FColor FColor::OrangeRed(255, 36, 0, 255);
const FColor FColor::Orchid(219, 112, 219, 255);
const FColor FColor::PaleGreen(143, 188, 143, 255);
const FColor FColor::Pink(188, 143, 143, 255);
const FColor FColor::Plum(234, 173, 234, 255);
const FColor FColor::Quartz(217, 217, 243, 255);
const FColor FColor::RichBlue(89, 89, 171, 255);
const FColor FColor::Salmon(111, 66, 66, 255);
const FColor FColor::Scarlet(140, 23, 23, 255);
const FColor FColor::SeaGreen(35, 142, 104, 255);
const FColor FColor::SemiSweetChocolate(107, 66, 38, 255);
const FColor FColor::Sienna(142, 107, 35, 255);
const FColor FColor::Silver(230, 232, 250, 255);
const FColor FColor::SkyBlue(50, 153, 204, 255);
const FColor FColor::SlateBlue(0, 127, 255, 255);
const FColor FColor::SpicyPink(255, 28, 174, 255);
const FColor FColor::SpringGreen(0, 255, 127, 255);
const FColor FColor::SteelBlue(35, 107, 142, 255);
const FColor FColor::SummerSky(56, 176, 222, 255);
const FColor FColor::Tan(219, 147, 112, 255);
const FColor FColor::Thistle(216, 191, 216, 255);
const FColor FColor::Turquoise(173, 234, 234, 255);
const FColor FColor::VeryDarkBrown(92, 64, 51, 255);
const FColor FColor::VeryLightGrey(205, 205, 205, 255);
const FColor FColor::Violet(79, 47, 79, 255);
const FColor FColor::VioletRed(204, 50, 153, 255);
const FColor FColor::Wheat(216, 216, 191, 255);
...
FLinearColor FLinearColor::LinearRGBToHSV() const noexcept
{
...
FLinearColor FLinearColor::HSVToLinearRGB() const noexcept
{
