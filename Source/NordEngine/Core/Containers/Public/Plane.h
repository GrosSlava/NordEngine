 ...
 */
MS_ALIGN(16) struct FPlane : public FVector3D
{
...
public:
	 ...
	 */
	FORCEINLINE FPlane(float InX, float InY, float InZ, float InW) noexcept :
		FVector3D(InX, InY, InZ), W(InW)
	{
	 ...
	 */
	FORCEINLINE FPlane(FVector3D InNormal, float InW) noexcept :
		FVector3D(InNormal), W(InW)
	{
	 ...
	 * @param InNormal Plane Normal Vector.
	 */
	FORCEINLINE FPlane(FVector3D InBase, const FVector3D& InNormal) noexcept :
		FVector3D(InNormal), W(InBase | InNormal)
	{
	 ...
	 */
	FORCEINLINE FPlane(FVector3D A, FVector3D B, FVector3D C) noexcept :
		FVector3D(((B - A) ^ (C - A)).GetSafeNormal())
	{
		W = A | (FVector3D)(*this);
	}
...
public:
	 ...
	 */
	FORCEINLINE float operator|(const FPlane& V) const noexcept
	{
	 ...
	 */
	FORCEINLINE FPlane operator+(const FPlane& V) const noexcept
	{
	 ...
	 */
	FORCEINLINE FPlane operator/(float Scale) const noexcept
	{
	 ...
	 */
	FORCEINLINE FPlane operator/=(float V) noexcept
	{
...
public:
	 ...
	 */
	FORCEINLINE const FVector3D& GetNormal() const noexcept
	{
		return *this;
	}
	 ...
	 */
	FORCEINLINE float PlaneDot(const FVector3D& P) const noexcept
	{
	 ...
	 */
	FORCEINLINE FPlane Flip() const noexcept
	{
