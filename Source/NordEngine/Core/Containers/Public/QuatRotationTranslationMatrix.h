...
public:
	...
	static FMatrix Make(const FQuat& Q, const FVector3D& Origin)  noexcept
	{
...
public:
	...
	* @param Q rotation
	*/
	FQuatRotationMatrix(const FQuat& Q)	 noexcept :
		FQuatRotationTranslationMatrix(Q, FVector3D::ZeroVector)
	{
...
public:
	...
	/** Matrix factory. Return an FMatrix so we don't have type conversion issues in expressions. */
	static FMatrix Make(const FQuat& Q) noexcept
	{
