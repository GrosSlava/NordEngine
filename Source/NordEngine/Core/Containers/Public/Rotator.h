...
public:
	 ...
	 */
	FORCEINLINE FRotator(float InF) noexcept :
	 ...
	 */
	FORCEINLINE FRotator(float InPitch, float InYaw, float InRoll) noexcept :
...
public:
	 ...
	 */
	FORCEINLINE FRotator operator+(const FRotator& R) const noexcept
	{
	 ...
	 */
	FORCEINLINE FRotator operator*(float Scale) const noexcept
	{
...
public:
	 ...
	 */
	FORCEINLINE FRotator GridSnap(const FRotator& RotGrid) const noexcept
	{
		return FRotator
		(
	 ...
	 */
	FORCEINLINE FRotator Clamp() const noexcept
	{
	...
	*/
	FORCEINLINE float GetManhattanDistance(const FRotator& Rotator) const noexcept
	{
	...
	*/
	FORCEINLINE FRotator GetEquivalentRotator() const noexcept
	{
...
public:
	 ...
	 */
	static FORCEINLINE uint8 CompressAxisToByte(float Angle)
	{
	 ...
	 */
	static FORCEINLINE float DecompressAxisFromByte(uint8 Angle)
	{
		// map [0->256) to [0->360)
	 ...
	 * @return The decompressed angle.
	 */
	static FORCEINLINE uint16 CompressAxisToShort(float Angle)
	{
	 ...
	 * @return The decompressed angle.
	 */
	static FORCEINLINE float DecompressAxisFromShort(uint16 Angle)
	{
	 ...
	 */
	static FRotator MakeFromEuler(const FVector3D& Euler);
