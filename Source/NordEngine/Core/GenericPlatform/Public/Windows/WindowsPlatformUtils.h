...
*/
#ifdef WIN64
#define PRAGMA_PUSH_PLATFORM_DEFAULT_PACKING __pragma(pack(push)) __pragma(pack(16))
#else
#define PRAGMA_PUSH_PLATFORM_DEFAULT_PACKING __pragma(pack(push)) __pragma(pack(8))
#endif
